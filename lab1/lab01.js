...
function handleNoteOn(key_number) {
    // Find the pitch
   let pitchStart = parseInt($("#pitch").val());
    //let pitchStart=60;
    let pitch = pitchStart + key_number;
    /*
...
*/
 function handleInstrument(evt){
  let instrument=parseInt($("#inputGroupSelect").val());
    ...
    MIDI.loadPlugin({
        ...
        onsuccess: function() {
            ...
            MIDI.programChange(0, 56);  // Use the General MIDI 'trumpet' number
             ...
             $("#inputGroupSelect").change( handleInstrument);
